...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'numb.nvim', 'nvim-comment', 'nvim-notify', 'nvim-spectre', 'dial.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
